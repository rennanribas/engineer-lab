...
export const EventLoopControls: React.FC<EventLoopControlsProps> = ({
  ...
  return (
    <div className='eventloop-controls'>
      <div className='controls-section controls-section--demos'>
        <h3 className='controls-title'>Event Loop Demonstrations</h3>
          ...
          {demoOptions.map((demo) => (
            ...
            >
              <div className='demo-card-header'>
                ...
                <span className={`demo-complexity demo-complexity--${demo.complexity.toLowerCase()}`}>
                  {demo.complexity}
                </span>
              </div>
      ...
      <div className='controls-section controls-section--playback'>
      ...
      <div className='controls-section controls-section--info'>
        ...
        <div className='info-grid'>
          <div className='info-card'>
            ...
            <h4>Call Stack</h4>
            <p>Executes functions synchronously in LIFO order. Must be empty for event loop to process queues.</p>
          </div>
          <div className='info-card'>
            <div className='info-icon'>⚡</div>
            <h4>Microtask Queue</h4>
            <p>High priority queue for Promises. Always processed before task queue when call stack is empty.</p>
          </div>
          <div className='info-card'>
            <div className='info-icon'>📋</div>
            <h4>Task Queue</h4>
            <p>Lower priority queue for timers and DOM events. Processed after all microtasks are complete.</p>
          </div>
          <div className='info-card'>
            <div className='info-icon'>🌐</div>
            <h4>Web APIs</h4>
            <p>Browser handles async operations like timers, HTTP requests, and DOM events outside the main thread.</p>
          </div>
        </div>
      </div>
    </div>
