        ...
        <div className="hero-container">
          <div className="hero-content">
            <h1 className="hero-title">
              ...
              <span className="hero-highlight">Concepts</span>
            </h1>
            <p className="hero-subtitle">
              Interactive demonstrations of fundamental computer science concepts
              and data structures through modern web technologies
            </p>
        ...
        <div className="about-container">
          <div className="about-content">
            ...
            <p className="about-text">
              This project demonstrates modern software engineering practices through
              interactive visualizations of fundamental computer science concepts.
              Built with a focus on clean architecture, type safety, and user experience.
            </p>
